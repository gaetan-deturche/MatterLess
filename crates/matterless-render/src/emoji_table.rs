...
// (https://raw.githubusercontent.com/mattermost/mattermost/master/server/public/model/emoji_data.go),
...
pub static GENERATED_ON: &str = "2026-09-04";
pub static SYSTEM_EMOJI: [(&str, &str); 4463] = [
    ("+1", "1f44d"),
